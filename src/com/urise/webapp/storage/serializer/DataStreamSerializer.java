...
public class DataStreamSerializer implements StreamSerializer {
    ...
    try(DataOutputStream dos = new DataOutputStream(os)) {
        ...
        Map<ContactType, String> contact = r.getContacts();
        writeCollection(dos,  contact.entrySet(), entry -> {
        ...
        writeCollection(dos,  r.getSection().entrySet(), entry -> {
            ...
            switch (type){
                ...
                case ACHIEVEMENT:
                case QUALIFICATIONS:
                    writeCollection(dos, ((ListSection) section).getItems(), item ->dos.writeUTF(item));
                    break;
                case EXPERIENCE:
                case EDUCATION:
                    writeCollection(dos,
       ...
       //     dos.writeUTF(entry.getKey().name());
        //    dos.writeUTF(entry.getValue());
       // }
      //  Map<SectionType, Section> section = r.getSection();
...
//            ElementProcessor contactElementProcessor = new ContactElementProcessor(dis, resume);
//            readItems(dis, contactElementProcessor);
...
//            }
            ...
            //resume.addSection(sectionType,value);
